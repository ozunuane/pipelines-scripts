...
#   value       = module.ecs_cluster_1.arn
# }

# output "cluster_id" {
#   description = "ID that identifies the cluster"
#   value       = module.ecs_cluster_1.id
# }

# output "cluster_name" {
#   description = "Name that identifies the cluster"
#   value       = module.ecs_cluster_1.name
# }

# output "cluster_capacity_providers" {
#   description = "Map of cluster capacity providers attributes"
#   value       = module.ecs_cluster_1.cluster_capacity_providers
# }

# output "cluster_autoscaling_capacity_providers" {
#   description = "Map of capacity providers created and their attributes"
#   value       = module.ecs_cluster_1.autoscaling_capacity_providers
# }
